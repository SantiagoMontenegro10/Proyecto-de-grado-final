...
@section('content')
        ...
        @foreach ($sql as $item)
            <form action="{{ route('cliente.renovar', $item->id_cliente) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="fl-flex-label mb-4 col-12 col-lg-6">
                        <label>Monto que debía el cliente anteriormente (COP)</label>
                    ...
                    <div class="fl-flex-label mb-4 col-12 col-lg-6">
                        ...
                        <input type="number" step="1" min="0" name="acuenta" class="input input__text" id="acuenta"
                            value="{{ old('acuenta') }}">
                        @error('acuenta')
                            <small class="error error__text">{{ $message }}</small>
                        @enderror
    ...
    let acuentaVal = parseInt(acuenta.value) || 0
    ...
    document.getElementById("pagoRestante").value = total - acuentaVal
}
