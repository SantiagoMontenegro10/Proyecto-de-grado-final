...
@section('content')
    ...
    <div class="pb-1 pt-2">
        ...
        <a href="{{ route('cliente.descargarTarjeta', ['pagina' => $sql->currentPage()]) }}" target="_blank" class="btn btn-rounded btn-secondary"><i class="fas fa-dumbbell"></i>&nbsp;
            Descargar clientes {{ $sql->firstItem() }} - {{ $sql->lastItem() }}</a>
    </div>
                    ...
                    @foreach ($sql as $key => $item)
                        <tr>
                            ...
                            <td>
                                @if ($item->debe == null or $item->debe == 0)
                                @else
                                    <a style="top: 0" href="{{ route('cliente.pagoCliente', $item->id_cliente) }}"
                                ...
                                <a style="top: 0" href="{{ route('cliente.datosCliente', $item->id_cliente) }}"
                                    class="btn btn-sm btn-info m-1"><i class="fas fa-edit"></i></a>
...
--}}
            ...
            <div class="text-right">
                ...
                Mostrando {{ $sql->firstItem() }} - {{ $sql->lastItem() }} de
                {{ $sql->total() }}
                resultados
            </div>
        </div>
