...
Route::get('/marcar/QRAdmin/{dni}', [AsistenciaController::class, 'marcarQRAdmin'])->name('marcar.QRAdmin')->middleware(['verified','administrador']);
...
Route::get("cliente-descargarTarjeta-{pagina}", [ClienteController::class, "descargarTarjeta"])->name("cliente.descargarTarjeta")->middleware("verified");
...
Route::post('/huella/registrar', [HuellaController::class, 'registrar'])
    ->name('huella.registrar');

    Route::get('/clientes/descargar', [ClienteController::class, 'descargarTarjeta'])
    ->name('clientes.descargar');
